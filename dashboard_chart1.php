...
if (!users_yetki(8)){
   die("Bu iþlemi yapmak için yetkiniz bulunmamaktadýr.");
}
...
<head>
    ...
    <script type="text/javascript" src="chart_repostory/js/bootstrap-datepicker.js?ver=1"></script>
    <script type="text/javascript" src="chart_repostory/js/bootstrap-datepicker.min.js?ver=1"></script>
...
<body>
    ...
    <div class="pc_panel_fixed" id="pc_panel_fixed">
        ...
        <div class="col-lg-10" style="padding: 0px;"><div class="pc_title"><?=dil_dashboard("TEDARÝK")?></div></div>
    ...
    <script>
       $(document).ready(function(){
            ...
            $("#succes_button").click(function(){
				...
				FILO_ACENTELER	= $('#FILO_ACENTELER').val();								
                $("#box").load("chart_repostory/load_data.php?brans=" +BRANS+ "&tarih1=" +tarih1+ "&tarih2=" +tarih2+ "&marka_id=" +MARKA_ID+ "&kullanim_sekli=" +KULLANIM_SEKLI+ "&tedarikci=" +TEDARIKCI+ "&filo_haric=" +FILO_HARIC+ "&filo_acenteler=" +FILO_ACENTELER+ "&faturali_haric=" +FATURALI_HARIC+ "&modul_haric=" +MODUL_HARIC);
            });
