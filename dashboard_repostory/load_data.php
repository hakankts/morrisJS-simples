<?php
    ...
    <div id="pc_content">
                <div class="pc_item">
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?=dil_dashboard("EKSPER","EKSPERT")?></h3>
                        </div>
                        <table class="table table-hover" id="dev-table">
                            <thead>
                                <tr>
                                    <th><?=dil_dashboard("Açýklama")?></th>
                                    <th><?=dil_dashboard("Adet")?></th>
                                    <th><?=dil_dashboard("Ort. Gün")?></th>
                                    <th><?=dil_dashboard("30 Gün+")?></th>
                                </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td><?=dil_dashboard("Dosya","File")?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Parça Ýþçilik Hareketi Olmayan Dosyalar")?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Servis Bilgisi Girilmemiþ Dosyalar")?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Pert Ýþaretlenen","Pert Marked")?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Tedarike Uygun Dosyalar")?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Neden Açýk Girilen")?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Kullanýcý Muallak Giriþi Yapýlmayan")?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Foto - Evrak Yüklenmemiþ")?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Maðdur Araç Bilgisi Girilmeyen")?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Rücu Ýþaretli")?> </td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Ön Rapor Gönderilen")?> </td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Ön Rapor Gönderilmeyen")?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Yedek Parça (Deðiþim)")?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Yedek Parça (Onarým)")?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Poliçe-Hasar Tarihi Fark <30");?></td>
                ...
                <div class="pc_item">
                        <div class="panel panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?=dil_dashboard("SERVÝS - MODÜL","SERVICE - MODUL")?></h3>
                        </div>
                        <table class="table table-hover" id="dev-table">
                            <thead>
                                <tr>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Ýlk Onaya Gönderilmemiþ");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Açýk Onaya Gönderilmemiþ");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Açýk Sigorta Mesaj Gelen");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Serviste Kapalý Sigorta Onayý Bekleyen");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Eksper Görevlendirilen");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Mobil Onarým Onayý Bekleyen");?></td>
                ...
                <div class="pc_item" id="faturali_kullanici" class="pdfNextPage">
                    <div class="panel panel-warning">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?=dil_dashboard("FATURALI KULLANICI","INVOICED USER");?></h3>
                    </div>
                        <table class="table table-hover" id="dev-table">
                            <thead>
                                <tr>
				...
				<div class="pc_item">
					<div class="panel panel-warning">
					<div class="panel-heading">
						<h3 class="panel-title"><?=dil_dashboard("TEKNÝK ÝNCELEMECÝ");?></h3>
					</div>
						<table class="table table-hover" id="dev-table">
							<thead>
								<tr>
                ...
                <div class="pc_item">
                    <div class="panel panel-warning">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?=dil_dashboard("CAM");?></h3>
                    </div>
                        <table class="table table-hover" id="dev-table">
                            <thead>
                                <tr>
                ...
                <div class="pc_item">
                    <div class="panel panel-warning">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?=dil_dashboard("TEDARIK","SUPPLY");?></h3>
                    </div>
                        <table class="table table-hover" id="dev-table">
                            <thead>
                                <tr>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Tedarikçiden Kod Beklenen Dosya");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Yeni Ýhale");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Cevaplanan Ýhale");?></td>
                            ...
                            <?php } ?>
                            <tr>
                                <td><?=dil_dashboard("Stok Kontrolünde (Cevaplanmamýþ)");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Sevk Tarihi Girilmemiþ");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Teslim Tarihi Girilmemiþ");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Fatura Girilmemiþ");?></td>
                            ...
                            <?php } ?>
                            <tr>
                                <td><?=dil_dashboard("Ýade Onay Bekleyen");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Yurt Dýþý Ýþaretlenen");?></td>
                ...
                <div class="pc_item">
                    <div class="panel panel-warning">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?=dil_dashboard("MOBÝL ONARIM");?></h3>
                    </div>
                        <table class="table table-hover" id="dev-table">
                            <thead>
                                <tr>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Mobil Onarýma Konu Olan");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Mobil Onarýma Gönderilen");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Mobil Onarým Cevap Bekleyen");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Mobil Onarýma Gönderilmeyen");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Mobil Onarým Ýptal");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Mobil Onarým Onarýlan","Mobile Repair Repaired");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Mobil Onarým Onarýlmayan");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Mobil Onarým Deðerlendirilmeyen");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Mobil Onarým Ýhale");?></td>
                ...
                <div class="panel panel-warning">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?=dil_dashboard("ARAÞTIRMACI");?></h3>
                    </div>
                        <table class="table table-hover" id="dev-table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                            <tr>
                                <td><?=dil_dashboard("Araþtýrmaya Konu Dosyalarý");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Araþtýrmacýda");?> </td>
                ...
                <div class="pc_item">
                   <div class="panel panel-warning">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?=dil_dashboard("UZMAN");?></h3>
                    </div>
                        <table class="table table-hover" id="dev-table">
                            <thead>
                                <tr>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Evrak Yüklenmeyen","");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Evrak Yüklenen","");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Araç Serviste Görülmeyen","");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Birinci Kontrol","");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Ýkinci Kontrol","");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Eksperde Kapalý Uzman onayý Bekleyen","");?></td>
                ...
                <div class="pc_item">
                   <div class="panel panel-warning">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?=dil_dashboard("OTO DIÞI","NON-AUTO");?></h3>
                    </div>
                        <table class="table table-hover" id="dev-table">
                            <thead>
                                <tr>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Muallak Giriþi Yapýlmayan","");?></td>
                ...
                <div class="pc_item">
                    <div class="panel panel-warning">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?=dil_dashboard("ALTERNATIF TAMÝR","ALTERNATIVE REPAIR");?></h3>
                    </div>
                        <table class="table table-hover" id="dev-table">
                            <thead>
                                <tr>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Teklife Çýkacak","");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Teklif Toplamada Olanlar","");?></td>
                            ...
                            <tr>
                                <td><?=dil_dashboard("Teklif Veren Anlaþmalý Serviste Tamirde","");?></td>
